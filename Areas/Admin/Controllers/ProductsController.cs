...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(OnlineShopDbContext context, IWebHostEnvironment webHostEnvironment)
        {
